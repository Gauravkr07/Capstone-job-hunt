...
from db.vector_store import get_job_vector_point, get_job_vector_points, get_resume_vector_point, search_similar_jobs
...
async def compute_ats_match(session: AsyncSession, username: str, job_id: int) -> AtsMatchResult:
    """
